...
def make_agent(env, seed=42, tensorboard_log="./logs/"):
    return DQN(
        ...
        batch_size=256,                    # how many sample should be sampled from the buffer at each optimization stage.
        gamma=0.99,
        train_freq=4,                      # the interval of steps between two training stages.
        gradient_steps=1,                  # In each training stage, how many optimization steps should be performed.
